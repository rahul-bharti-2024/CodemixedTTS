...
def process_file(file):
    ...
    segment_len = get_codec_len(osp.join('/home/rahul_b/IndicVoices-R/VoiceCraft/datasets/mucs/xs/encodec_16khz_4codebooks', file))
...
if __name__ == '__main__':
    ...
    code_files = set(os.listdir('/home/rahul_b/IndicVoices-R/VoiceCraft/datasets/mucs/xs/encodec_16khz_4codebooks'))
    phoneme_files = set(os.listdir('/home/rahul_b/IndicVoices-R/VoiceCraft/datasets/mucs/xs/encodec_16khz_4codebooks'))
    ...
    train = read_jsonl('/home/rahul_b/IndicVoices-R/VoiceCraft/datasets/mucs/manifests/metadata_mucs_train.jsonl')
    ...
    test = read_jsonl('/home/rahul_b/IndicVoices-R/VoiceCraft/datasets/mucs/manifests/metadata_mucs_test.jsonl')
