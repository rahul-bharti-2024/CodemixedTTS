...
@dataclass
class Config:
    manifest_path: str = '/home/rahul_b/IndicVoices-R/VoiceCraft/datasets/mucs_roman/manifests/metadata_mucs_test_romanized2.jsonl'
    model_path: str = '/mnt/LS226/LS25/rahul2022387/Results/Voicecraft/logs/mucs_roman/e830M/best_bundle.pth'
    output_dir: str = '/mnt/LS226/LS25/rahul2022387/OpenSLR/Results_mucs_roman'
